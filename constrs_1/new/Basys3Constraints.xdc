...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets demo_IBUF]	
...
#set_property PACKAGE_PIN T1 [get_ports {RC}]					
...
#set_property PACKAGE_PIN T18 [get_ports RC]						
#	set_property IOSTANDARD LVCMOS33 [get_ports RC]
...
##Pmod Header JXADC
##Sch name = XA1_P
set_property PACKAGE_PIN J3 [get_ports {interrupt}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {interrupt}]
##Sch name = XA2_P
